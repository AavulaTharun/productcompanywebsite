...
<html lang="en">
  <head>
    ...
    <div class="footer">
      Copyright &#169; 2021 Vasu health Care Private Limited, Developed by Tharun.A.
    </div>
  </div>
</body>
</html>
    ...
    <div class="container">
      ...
      <div class="content">
        <div class="homecontent">
          ...
          <h1>Phone:</h1><br>
          <div class="contenttext">
              Mr.Tharun(HR):9573819022<br><br>
              Mr.sameer(Assistant HR):9010525372
          </div>
          <h1>E-Mail:</h1><br>
          <div class="contenttext">
              Sales:tharunyadavaavula2002@gmail.com
          </div>
        </div>
      </div>
      <div class="footer">
        Copyright &#169; 2021  google products Private Limited, Developed by Tharun.A.
      </div>
    </div>
  </body>
</html>
...
![output](https://github.com/AavulaTharun/productcompanywebsite/blob/main/HOME%201.JPG?raw=true)
## products
![output](https://github.com/AavulaTharun/productcompanywebsite/blob/main/PRODUCTS1.JPG?raw=true)
## people
![output](https://github.com/AavulaTharun/productcompanywebsite/blob/main/people%201.JPG?raw=true)
## contact us
![output](https://github.com/AavulaTharun/productcompanywebsite/blob/main/contactus.JPG?raw=true)
## Result:
